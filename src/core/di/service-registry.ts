...
export function registerCoreServices(): void {
  ...
  ServiceRegistry.register('character', () => characterService, true);
  ...
  ServiceRegistry.register('storyboard', () => storyboardService, true);
...
ServiceRegistry.register('subtitle', () => subtitleService, true);
  ServiceRegistry.register('video-analysis', () => videoAnalysisService, true);
  ServiceRegistry.register('export', () => exportService, true);
  ServiceRegistry.register('composition', () => compositionService, true);
