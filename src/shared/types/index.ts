...
// ========== Novel Types (extracted to novel.ts) ==========

export * from './novel';

// Original types commented out - moved to novel.ts
...
// ========== Composition/Animation Types (extracted to composition.ts) ==========

export * from './composition';

// Original types commented out - moved to composition.ts
/*
